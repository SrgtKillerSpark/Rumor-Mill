# Rumor Mill — Steam Store Page (Final)

*Ready to paste into Steamworks store page editor.*

---

## Short Description

> A medieval social strategy game where words are your weapon. Plant rumors, manipulate reputations, and guide whispers through a living town of 30 NPCs — before the wrong person finds out it was you.

**Character count: ~222 / 300 max**
...
**Primary (highest-weight — enter first):**
1. Strategy
2. Simulation
3. Indie
4. Social Deduction
...
*Enter all 20 in Steamworks for maximum discoverability. First 5 are highest-weight in Valve's algorithm.*
...
| **Additional Notes** | 1280×720 display resolution required |
...
| **Memory** | 4 GB RAM |
| **Graphics** | Dedicated GPU, 1 GB VRAM |
| **DirectX** | Version 11 |
| **Storage** | 500 MB available space |
| **Additional Notes** | 1920×1080 display for full social graph visibility |

*Note: Mac and Linux support is planned but not confirmed for Early Access launch.*

...
func _build_objectives_section() -> void:
	...
	) % [(sm.S1_WIN_EDRIC_BELOW if sm != null else 30), edric_score_str, edric_band_str, s1_win_status, (sm.S1_WIN_EDRIC_BELOW if sm != null else 30)]
	...
	) % [(sm.S3_WIN_CALDER_MIN if sm != null else 75), (sm.S3_WIN_TOMAS_MAX if sm != null else 35),
		calder_score_str, calder_band_str, (sm.S3_WIN_CALDER_MIN if sm != null else 75),
		tomas_score_str, tomas_band_str, (sm.S3_WIN_TOMAS_MAX if sm != null else 35)]
	...
	) % [S4_DAYS, (sm.S4_WIN_REP_MIN if sm != null else 48), s4_win_status,
		aldous_score_str, aldous_band_str,
		vera_score_str, vera_band_str,
		finn_score_str, finn_band_str,
		(sm.S4_WIN_REP_MIN if sm != null else 48)]
	...
	) % [(sm.S4_FAIL_REP_BELOW if sm != null else 42), S4_DAYS, s4_days_remaining]

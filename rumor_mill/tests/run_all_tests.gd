...
##   • TestEventAftermathScreen   — palette, layout constants, initial node refs null, _format_effects() (SPA-2777)
...
##   • TestForeshadowHud          — palette, layout constants, initial node refs null, setup(), _on_day_changed() guard (SPA-2777)

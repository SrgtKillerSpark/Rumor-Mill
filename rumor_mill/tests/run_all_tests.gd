...
##   • TestFesMemoryIntegration   — FES → FactionMemoryHorizon.record_action() wiring for all four event types (SPA-4111)
...
const TestFesMemoryIntegration = preload("res://tests/test_fes_memory_integration.gd")
...
func _init() -> void:
	...
	TestFesMemoryIntegration.new().run()

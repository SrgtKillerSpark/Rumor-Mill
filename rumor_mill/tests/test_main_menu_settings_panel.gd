...
static func test_c_panel_border_amber() -> bool:
	...
	var ok: bool = sp.C_PANEL_BORDER.r > 0.45 and sp.C_PANEL_BORDER.b < 0.25
	sp.free()
	return ok
...
static func test_c_btn_text_near_white() -> bool:
	var sp := _make_sp()
	var ok: bool = sp.C_BTN_TEXT.r > 0.90 and sp.C_BTN_TEXT.g > 0.85 and sp.C_BTN_TEXT.b > 0.75
	sp.free()
	return ok
...
static func test_initial_lbl_master_val_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._lbl_master_val == null
	sp.free()
	return ok
...
static func test_initial_lbl_music_val_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._lbl_music_val == null
	sp.free()
	return ok
...
static func test_initial_lbl_ambient_val_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._lbl_ambient_val == null
	sp.free()
	return ok
...
static func test_initial_lbl_sfx_val_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._lbl_sfx_val == null
	sp.free()
	return ok
...
static func test_initial_lbl_speed_val_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._lbl_speed_val == null
	sp.free()
	return ok
...
static func test_initial_btn_resolution_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._btn_resolution == null
	sp.free()
	return ok
...
static func test_initial_btn_window_mode_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._btn_window_mode == null
	sp.free()
	return ok
...
static func test_initial_btn_window_scale_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._btn_window_scale == null
	sp.free()
	return ok
...
static func test_initial_btn_ui_scale_null() -> bool:
	var sp := _make_sp()
	var ok: bool = sp._btn_ui_scale == null
	sp.free()
	return ok

...
static func test_scenario_accent_count() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_ACCENT.size() == 6
	ss.free()
	return ok
...
static func test_scenario_accent_s1_is_green() -> bool:
	...
	var ok: bool = c.g > 0.60 and c.r < 0.55
	ss.free()
	return ok
...
static func test_scenario_accent_s4_is_red() -> bool:
	...
	var ok: bool = c.r > 0.75 and c.g < 0.30
	ss.free()
	return ok
...
static func test_scenario_difficulty_count() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_DIFFICULTY.size() == 6
	ss.free()
	return ok
...
static func test_scenario_difficulty_s1_introductory() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_DIFFICULTY.get("scenario_1", "") == "Introductory"
	ss.free()
	return ok
...
static func test_scenario_difficulty_s2_moderate() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_DIFFICULTY.get("scenario_2", "") == "Moderate"
	ss.free()
	return ok
...
static func test_scenario_difficulty_s3_challenging() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_DIFFICULTY.get("scenario_3", "") == "Challenging"
	ss.free()
	return ok
...
static func test_scenario_difficulty_s4_expert() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_DIFFICULTY.get("scenario_4", "") == "Expert"
	ss.free()
	return ok
...
static func test_scenario_difficulty_s5_advanced() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_DIFFICULTY.get("scenario_5", "") == "Advanced"
	ss.free()
	return ok
...
static func test_scenario_difficulty_s6_master() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_DIFFICULTY.get("scenario_6", "") == "Master"
	ss.free()
	return ok
...
static func test_scenario_descriptor_count() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.SCENARIO_DESCRIPTOR.size() == 6
	ss.free()
	return ok
...
static func test_initial_selected_scenario_empty() -> bool:
	var ss := _make_ss()
	var ok: bool = ss.selected_scenario.is_empty()
	ss.free()
	return ok
...
static func test_initial_scenario_cards_empty() -> bool:
	var ss := _make_ss()
	var ok: bool = ss._scenario_cards.is_empty()
	ss.free()
	return ok
...
static func test_initial_scenarios_empty() -> bool:
	var ss := _make_ss()
	var ok: bool = ss._scenarios.is_empty()
	ss.free()
	return ok
